                    ...
                    <Row>
                        <Col>
                            <Tabs defaultActiveKey="1">
                                <TabPane tab="Holland" key="1"><Table rowKey={record => record.id} loading={data.isLoading} columns={columnsEnableItems} dataSource={enableItem} onChange={this.handleChange} /></TabPane>
                                <TabPane tab="MBTI" key="2"><Table rowKey={record => record.id} loading={data.isLoading} columns={columnsDisableItems} dataSource={disableItem} onChange={this.handleChange} /></TabPane>
                            </Tabs>
                        </Col>
                    </Row>
                </div>
